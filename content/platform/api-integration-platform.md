---
date: "2022-01-10"
title: API integration platform | Clairdash
description: Clairdash's API integration platform helps you integrate with your APIs and build internal apps, forms, admin panels, and more in minutes.
draft: "false"
type: product
layout: single
theme: light-2
...
secondBenefitDescription: Clairdash's API integration platform helps you integrate with your APIs and build internal apps in minutes. Simply create a REST API datasource within Clairdash, enter the URL of the API endpoint, run your query. When Clairdash pulls back your data, you can quickly build a beautiful CRUD application in seconds within the design section. 
