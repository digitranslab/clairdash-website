...
But, before we start the  tutorial, a quick recap on what we define as a web application at Clairdash.
...
Low-code offers just as much, if not more, for less technical types. For example, Clairdash empowers users to build fully functional, professional web apps, without writing a single line of code.
...
2. Use a web app builder like Clairdash - As a builder, Clairdash will remove the need to learn a backend language. On top of that, Clairdash will also take care of a lot of your DevOps tasks such as hosting.
...
Building your backend is one of the toughest parts of web app development. If you feel overwhelmed, a tool like [Clairdash](https://www.clairdash.com) can take away many of the complexities - including the follow tasks.
...
* Try [Clairdash](https://www.clairdash.com)
...
When using Clairdash, this step can be automated with [Clairdash hosting](https://www.clairdash.com/). With Clairdash, you are still required to buy a domain.

If you are not using Clairdash to host your web application, follow these quick steps: \\
...
And they’re finding that Clairdash is their best bet.

### Introducing Clairdash

Clairdash is leading the charge in the low-code revolution. [Our open-source low-code platform](https://clairdash.com/blog/open-source-low-code-platforms/) is the perfect solution for building a web app, whether you’re a complete beginner or a seasoned pro.

Thousands of hobbyists, businesses, and major enterprises around the world choose Clairdash for fast builds, incredible developer experiences, and total control over their projects.

## How to build a web app in Clairdash - 4 steps

The beauty of Clairdash is that we offer the perfect combination of simplicity, efficiency, and flexibility. That is, our platform takes the legwork out of common tasks, while still offering you enough customization to build the perfect tools for your specific requirements.
...
With Clairdash, it’s easy to make changes to any part of your app, on the fly.
...
Clairdash offers two different strands here:

1. ClairdashDB, our internal database.
2. Dedicated connector tools for external data sources.

Let’s take a look at the first option first.

Clairdash DB is by far the easiest, most intuitive way to [create a data model](https://clairdash.com/blog/data/how-to-create-a-data-model/) for a web app, regardless of your skill level.
...
ClairdashDB supports a full complement of data types. Obviously, we’ve got the basics, like strings, numbers, dates, and boolean expressions. We also offer more advanced data types, including formula variables, simple relationships, file attachments, and JSON objects.

Alternatively, Clairdash sits perfectly alongside your existing external data sources.

Use dedicated connectors for a market-leading variety of [data sources](https://clairdash.com/blog/data/data-sources/), including Google Sheets, SQL, Postgres, REST, Airtable, Oracle, and more.
...
Clairdash comes fully loaded with features to creating web app designs an absolute breeze.

We offer a huge library of built-in components, with each one offering an incredible degree of configurability. Clairdash is perfect for building dashboards, forms, admin panels, and more, without writing a single line of code.
...
Next, we can start to build out automated processes. Again, the idea behind Clairdash is that you can achieve incredible results without writing code, but you still have the option to hard-code if you want to.
...
Clairdash also offers a huge amount of flexibility for how you trigger your automations, whether it be user actions, system events, or external factors.

You can also use external integrations for automation triggers and actions alike. Clairdash makes it incredibly easy to build a web app that sits neatly alongside your existing software stack.

Check out our guide to [web application development ](https://clairdash.com/blog/web-application-development/)to find out more.

### 4. Deploy your app

Finally, it’s time to deploy your tools. One option here is to use Clairdash Cloud, our free, one-click hosting platform. That way, you can let us take care of everything.
...
Let's take a look at how Clairdash helps turn data into action.
...
No other player in the low-code space comes close to Clairdash for external data support. We offer dedicated conenctors for SQL, Postgres, Airtable, Mongo, Couch, S3, REST, Google Sheets, Couch, Oracle, and more.
...
Host Clairdash on your own infrastructure for complete control. We offer self-hosting through Kubernets, Docker, Docker Compose, Digital Ocean and more.

We also offer Clairdash Cloud, our own proprietary cloud-based hosting, to help you ship professional web apps in just a few clicks.33

### Configurable RBAC

Use Clairdash's built-in role-based access control to assign the perfect data exposure and permission for every single user. Assign employees to a predefined role, and grant access at the level of data sources, queries, automations, app screens, or even individual components.

There's never been an easier way to create secure web apps that don't compromise on usability.

### Custom plug-ins

Clairdash leads the pack for extensibility. Use our dedicated CLI tool to create your own data sources and components to ship across all of your low-code solutions.

Take a look at our [plug-ins docs](https://docs.clairdash.com/docs/custom-plugin) to learn more.

### 50+ app templates

Clairdash is the fast, easy way to build incredible web apps. Whether you’re a complete beginner, or a professional developer, our low-code platform offers unrivaled speed, flexibility, and developer experiences.

But don’t just take our word for it.

We’ve also created 50+ free [app templates](https://clairdash.com/templates) to show off just what Clairdash can do. Use any one of them as a jumping-off point for your custom tools, or launch one today as a fully functional solution.