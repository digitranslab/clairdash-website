...
Take a look at our guide to the most common [types of workflows](https://clairdash.com/blog/automation/types-of-workflow/).
...
It’s worth noting that we’ll often need to balance competing concerns here. For example, we may have a clear need for automation but limited resources for achieving it. We’ll return to how Clairdash can help bridge the gap here a little later.
...
Check out our ultimate guide to [role-based access control](https://clairdash.com/blog/app-building/role-based-access-control/).
...
We also offer our own built-in database, ClairdashDB. Import CSV files or build a data layer from scratch to get your app build off the ground without writing a single line of code.
