...
Therefore, today we are going to explore how you can build a free MySQL web interface using Clairdash. You are going to learn how to:
...
In addition, you can build your own MySQL GUI using the tips from this 5-step guide, leveraging Clairdash as a MySQL frontend builder.
...
If you haven’t already, sign up for Clairdash. You can create free apps right away.

{{< cta >}}

After you’ve created your app, connect to your MySQL database as a [data source](https://clairdash.com/blog/data/data-sources/). Don’t forget to [whitelist the Clairdash servers](https://docs.clairdash.com/docs/whitelisting) in your MySQL server \- or ask your database administrator to do so.

Our demo data has three tables:

* **Saved queries** - A table using the Clairdash DB to store the saved queries in the custom query screen
...
We create this procedure with the name execute_immediate. Clairdash offers a dedicated SQL editor with syntax highlighting as a key feature of our query builder.

Then in the data tab for Clairdash, you can create these queries:
...
Create a new screen, and in its route use /edit/:table/:id. This is how you tell Clairdash to create app variables based on the current URL.
...
## Build a MySQL GUI with Clairdash
...
You might also like to check out our ultimate guide to building [database GUIs](https://clairdash.com/blog/tutorials/database-gui/).
