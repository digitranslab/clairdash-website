...
This allows you to get the best of both worlds. A flexible [data source](https://clairdash.com/blog/data/data-sources/), along with a powerful user-facing app.
...
You can use Google Sheets as a dashboard, by using custom styles, charts, and App Script to run functions. But it’s probably better and easier to use a free no-code builder such as Clairdash to [create a custom Dashboard for Google sheets](https://clairdash.com/blog/data/google-sheets-dashboard/).
...
Check out our guide to [data entry automation](https://clairdash.com/blog/data/data-entry-automation/).
...
1. Clairdash sends an email to your customer, using the title and contents from your form
...
If you haven’t already, sign up for Clairdash. Then create a new app and select Google Sheets as your data source.
...
This URL makes it so that Clairdash loads a different link for each row. They all follow the same pattern: /contacts/:ID.
...
You might also like our guide on [how to build a dashboard](https://clairdash.com/blog/tutorials/how-to-build-a-dashboard/).
...
This is what allows Clairdash to understand that whatever is after contacts/ should be stored in a variable called “ID”. You can access it using {{ URL.id }}.
...
Go to your main Clairdash screen - before the app selection - and click on “Email”.
...
## Building a Google Sheets GUI with Clairdash
...
Take a look at our ultimate guide to [database GUIs](https://clairdash.com/blog/tutorials/database-gui/) for more inspiration.
