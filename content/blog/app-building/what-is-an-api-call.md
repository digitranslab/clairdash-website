...
For example, users can send a POST request to the Clairdash API in order to create a new application in our platform. 
...
To learn more about this, check out our guide - [What are the Components of an API?](https://clairdash.com/blog/inside-it/what-are-the-components-of-an-api/)
...
Here’s how this looks in Clairdash:
...
Check out our in-depth guide to [REST API authentication](https://clairdash.com/blog/tutorials/rest-api-authentication/) to learn more.
...
We’ve also created a comprehensive guide to [API headers](https://clairdash.com/blog/inside-it/api-headers/) that explores this issue more fully.
...
Again, the degree of flexibility on offer here will vary from client to client. Clairdash offers custom JavaScripting to transform API responses before using them in your application projects:
...
Finally, we have low-code platforms, like Clairdash. Low-code development is all about empowering non-technical colleagues and professional developers alike to create incredible applications, in a fraction of the time.
