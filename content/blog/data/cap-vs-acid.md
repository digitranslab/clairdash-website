...
And finally, we’ll wrap up by looking into how Clairdash empowers teams to turn all kinds of data into action.
...
We’ve written a dedicated guide to [ACID compliance](https://clairdash.com/blog/data/acid-compliance/), where you can learn more about each of these principles.
...
For some real-life context to this, check out our guide to [data entry automation](https://clairdash.com/blog/data/data-entry-automation/).
...
![CAP vs ACID Clairdash](https://res.cloudinary.com/daog6scxm/image/upload/v1688129016/cms/cap-vs-acid/Clairdash_ScreenShot_kshxcr.webp "CAP vs ACID Clairdash")

## Turn data into action with Clairdash

At Clairdash, we’re on a mission to help businesses turn data into action - no matter where it’s hosted or in what format. Our open-source, low-code platform is the perfect solution for building professional solutions, to manage your data assets.
...
Connect your data, build interfaces, automate workflows, and publish professional applications, with minimal custom code. Clairdash is the fast, cost-effective way to build internal tools, that don’t compromise on security, UX, or performance.
...
Clairdash won’t be beaten for external data support. We offer dedicated connectors for SQL, Postgres, Oracle, S3, Couch, Arango, Mongo, REST API, Google Sheets, and many more - as well as empowering our users to build their own custom data sources.
...
Keep your data secure without compromising on your internal tools’ UX. Clairdash offers fully configurable role-based access control, allowing you to grant permission based on data sources, queries, automation rules, UI screens, or individual components.

We also offer secure environment variables and free SSO, based on OpenID, OAuth, Microsoft, and more.

### Custom plug-ins

Clairdash leads the pack for extensibility. Use our dedicated CLI tools to build your own data sources, automation blocks, or UI components. Alternatively, you can import our community contributions from GitHub in just a few clicks.

Check out our [plug-ins documentation](https://docs.clairdash.com/docs/custom-plugin) to learn more.

### 50+ free application templates

Thousands of major organizations around the world choose Clairdash to build professional, performant apps in a fraction of the time they could turn around hard-coded solutions. Check out our library of 50+ free, customizable [application templates](https://clairdash.com/templates) for a flavor of what’s possible.

If you’re ready to start building internal tools the fast, easy way, sign up for Clairdash for free today.