...
With some tools, like ClairdashDB, you’ll be able to use additional data types, such as _file attachments, relationships_ or _long-form text fields_.
...
To understand how let's take a look at how Clairdash handles different kinds of data.

### ClairdashDB

ClairdashDB is our built-in database. We’re biased, but we think this is the fastest way anyone can build a database for their app project. Add tables, create attributes, and enter rows, at the click of a button.
...
ClairdashDB also supports relationships between entities, without the need for any DBMS knowledge. Assign a display column, and create complex relationships in seconds.

![ClairdashDB](https://res.cloudinary.com/daog6scxm/image/upload/v1653318188/cms/Clairdash_DB_s3zdq2.png "ClairdashDB")
...
With CSV uploads, autogenerated CRUD screens, and automatically updatable form UIs, Clairdash is the fast, easy way to build tools around your perfect database schema.

### Connecting to external databases

We also offer extensive connectivity for a range of external databases. You can build Clairdash apps around SQL, Postgres, MongoDB, Airtable, and more. Leverage existing data, or build your database schema from scratch, using your preferred DBMS.

Clairdash gives developers the power to create the perfect data layer for their specific apps. Build your own in-depth database schema, or use ClairdashDB to create a flexible, scalable database in seconds.
...
## Start using Clairdash

Our users choose Clairdash for fast, cost-effective builds, and unrivaled flexibility. Build your data layer, create professional UIs, and deploy finished apps, in minutes.

Use ClairdashDB to quickly build an adaptable database schema or query eternal databases with our range of connectors.

You might also enjoy our guide on [how to create a data model](/blog/data/how-to-create-a-data-model).

Start using Clairdash today, for free.