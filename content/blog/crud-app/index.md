...
Clairdash is a low code platform that is designed for creating CRUD applications. From the frameworks, tech stacks, and platforms listed above, Clairdash is the easiest and fastest way to build a CRUD application. For these reasons, we will use Clairdash to build our CRUD app.
...
There are three high-level steps to building our CRUD app; setting up Clairdash, create our data structure, and designing our user interface.

#### Setting up Clairdash

If you are new to Clairdash, click the ‘Get started’ button in the navigation (if on mobile, click the burger menu, then the ‘Get started’ button). Once you have Clairdash setup, follow the actions below:
...
Clairdash has its own database and supports several others; including MySQL, PostgreSQL, Mongo, and more. For our CRUD app, we will simply use Clairdash’s internal database - Clairdash DB.

##### Actions:

* Create a Clairdash DB table, and call it ‘Books’
...
The design section is where we create our User Interface. You will notice on the left-hand side of your screen, there is a list of screens/routes and components. These screens were autogenerated by Clairdash. Clairdash is smart enough to know that for each Clairdash table you create, you will need a new, list, and detail screen, in other words, a create (new), read (list), update + delete (detail) screen. This makes it faster and easier to build CRUD apps. Let’s get started.
...
{{< figure src="/blog/crud-app/images/update-form-fields.webp"  alt="Update form fields in Clairdash app" >}}
...
Check out our ultimate guide to [data sources](https://clairdash.com/blog/data/data-sources/) to find out more.

## CRUD app templates

You can find over 50 CRUD app templates on the Clairdash template page. These templates are free, 100% customizable, and simple to install.

[View Clairdash templates](https://clairdash.com/templates)
