...
To understand the relationship better, we can think about an example. Say you wanted to transform your [internal processes](https://clairdash.com/blog/automation/internal-processes/) for managing client finances. 
...
![Clairdash Screengrab](https://res.cloudinary.com/daog6scxm/image/upload/v1683900004/cms/digital-enablement/Screenshot_2023-05-12_at_13.53.46_qdjosz.webp "Clairdash screenshot")

## Empower your team to do more with Clairdash
...
With responsive design tools, extensive external data support, and unrivaled extensibility, Clairdash is the fast, easy way to create professional applications, with minimal custom coding skills.
...
Clairdash leads the pack for external data support. Our platform features dedicated connectors for SQL, Postgres, S3, Oracle, Airtable, Mongo, Couch, Google Sheets, REST API, and more.

We also have our own built-in database, with extensive support for a whole range of different data types.

### Optional self-hosting

With Clairdash, you’re in control of how and where you host your solutions. Deploy to your own infrastructure with Kubernetes, Docker, Digital Ocean, and more. Or, use Clairdash Cloud and let us handle everything.
