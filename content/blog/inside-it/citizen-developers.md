...
So, it’s important to shop around. Again, we’ll return to this when we come to look at how Clairdash supports citizen developers.
...
Naturally, if you want to opt for any of these strategies, you’ll need to choose an app-building platform that supports them. We’ll return to this shortly when we come to look at what Clairdash offers for citizen developers.
...
Each of these will inform later decisions, especially around your software stack. For example, if you’re anticipating a large number of diverse users, you’ll likely need more advanced security tools, like [role-based access control](https://clairdash.com/blog/app-building/role-based-access-control/).
...
If you don’t know what this means, you can check out our guide to [open-source, low-code platforms](https://clairdash.com/blog/open-source-low-code-platforms/).
...
Gone are the days of unwieldy, grey, inflexible app-builders. Instead, modern platforms offer incredible versatility, usability, and expediency. As we’ll see a little later, Clairdash is leading the pack.
...
Check out our [approval apps](https://clairdash.com/approval-apps/) page for more information.
...
Self-hosting, either locally or on a private cloud, offers a much greater degree of flexibility, and security. However, this also brings extra costs, maintenance needs, and other responsibilities. We’ll look at how Clairdash stacks up for hosting and deployment a little later.
...
One is [app UI design](https://clairdash.com/blog/app-building/app-ui-design/). In other words, the interfaces that your team builds for users to interact with their apps.
...
Check out our [admin panels](https://clairdash.com/admin-panels) page for more information on what Clairdash brings to the table here.

## Citizen developers, low-code, and Clairdash

Low-code development is totally transforming the way businesses build custom tools. Clairdash is leading the charge.

Whether you want to empower non-technical staff to build their own solutions or free your professional developers from boring, repetitive projects, Clairdash is the fast, easy way to build professional applications.
...
Connect your data source and create a fully functional [CRUD app](https://clairdash.com/blog/crud-app/), at the press of a button.

Alternatively, Clairdash makes it easy to build fully custom apps from scratch. With our innovative design interface, you can create sleek, performant UIs, without writing a single line of code.
...
Clairdash supports an unrivaled range of [data sources](https://clairdash.com/blog/data/data-sources/). We offer dedicated connectors for MySQL, MSSQL, Postgres, S3, Airtable, Google Sheets, Oracle, MongoDB, CouchDB, REST API, and more.

We also offer our own built-in database, with CSV uploads.

Whether you need to [create a data model](https://clairdash.com/blog/data/how-to-create-a-data-model/) from scratch or leverage existing business insights, Clairdash has you covered.

Clairdash is the perfect way to build user-friendly tools for managing, transforming, updating, and visualizing data, no matter where it comes from.
...
We give our users complete control over how they deploy their tools. Choose Clairdash Cloud or deploy to your own infrastructure with Kubernetes, Docker, Docker Compose, Digital Ocean, and more.
...
Set up a Clairdash tenant with your chosen hosting method and your team can publish their creations, at the press of a button.

Take a look at our [hosting and deployment docs](https://docs.clairdash.com/docs/hosting-settings) to find out more.
...
Clairdash also sits seamlessly alongside your existing software stack, with full integrability with a vast array of external platforms, using WebHooks, Zapier, and REST API.
...
The thing is, we have an enormous amount of confidence in our platform. So do tens of thousands of other companies around the world. We’re pretty sure that, once you’ve tried Clairdash for yourself, you’ll agree too.

So why take our word for it?

To prove what you can do with Clairdash, we’ve created more than 50 free, deployable [app templates](https://clairdash.com/templates). Use any one of them as a fully functional solution, or customize and tweak them to your heart’s content.

Or, if you prefer, you can build your own tools from scratch. The choice is yours.

Either way, you can sign up to Clairdash today for free to get started.