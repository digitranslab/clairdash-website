...
+++
Over the last year, we've been building an open-source, low-code platform for developers and IT professionals. We've been so bogged down building the product and talking to users; we completely neglected the [Clairdash Github repo](https://github.com/Clairdash/clairdash).
...
You can [view a live version of this chart](https://star-history.t9t.io/#clairdash/clairdash).
...
## 1. Update your [Github Readme](https://github.com/Clairdash/clairdash)

Our old Github Readme consisted of a title and an outdated way to run Clairdash - that was it! This had to change. It provided negative value.
...
{{< figure src="https://dev-to-uploads.s3.amazonaws.com/i/5ytmkrihb1dd5ze12gbw.png" alt="Clairdash Github Readme" >}}

You can [access the Readme here](https://github.com/Clairdash/clairdash/blob/master/README.md).

## 2. Get email involved

When a user signs up for Clairdash, we send an automated email. We previously sent a general 'Welcome to Clairdash' email including a number of CTAs signposting the user to different Clairdash channels.
...
{{< figure src="https://dev-to-uploads.s3.amazonaws.com/i/zg3w29qr0bkggxgpwpje.png" alt="Welcome to Clairdash email" >}}
...
You can [see the button on the website here](https://www.clairdash.com/).
...
{{< figure src="https://dev-to-uploads.s3.amazonaws.com/i/ojjirvjtwuvscxzbpyrm.png" alt="Clairdash Twitter" >}}

## 5. Github Discussions

We previously managed our community on Discourse. We decided to make the move to [Github Discussions](https://github.com/Clairdash/clairdash/discussions) and it's been a great experience to date. They are continually releasing new features, and for an open-source product, it's nice to have your community beside your code. It's also nice to have your community beside the Github Star button too!

{{< figure src="https://dev-to-uploads.s3.amazonaws.com/i/w03obla34w07dkjidwj0.png" alt="Clairdash Github Discussions" >}}

## 6. Public roadmap (on Github)

Clairdash is open source, so it's important our roadmap is public so users understand what's coming down the line, and provide feedback. We use Github Projects to manage [our roadmap](https://github.com/Clairdash/clairdash/projects/10), and like Discussions, it's great having our users on Github where they can star us, contribute, and collaborate with others.

{{< figure src="https://dev-to-uploads.s3.amazonaws.com/i/w9ey4tqu32ia9r46lu8u.png" alt="Clairdash roadmap" >}}
...
If you have any questions or ideas, please reach out in the comments and I will do my best to help. Also, if you get a chance, [star our repo](https://github.com/Clairdash/clairdash). Please include your repo below - I'll check it out and give it a star - everyone deserves a boost in life!
