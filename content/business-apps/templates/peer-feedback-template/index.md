...
Clairdash tools are ideal as [web applications](https://clairdash.com/blog/5-examples-of-web-application-design/) or local [internal tools](https://clairdash.com/internal-tools).
