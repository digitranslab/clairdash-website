...
We also offer our own built-in database, that supports spreadsheet-data uploads. Use Clairdash to build apps from scratch or using leveraging your existing data.
